...
class Product extends \yii\db\ActiveRecord
{
    ...
    public static function getProductImage($imgName,$path)
    {
     ...
     public static function getDescription($description,$id,$maxchar=10)
    {
       
         
    	if(strlen($description)>$maxchar)
            $text=  substr($description, 0,$maxchar).Html::a(Yii::t('app', ' More...'),['/site/productdetail', 'ProductId' => $id],['target' => '_blank',]);
