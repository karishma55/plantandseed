...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $banners =  Banner::find ()->where ( [ 
				'is_status' => 0,				
		] )->orderBy(['banner_id' => SORT_ASC])->all ();
        ...
        elseif($catId!=''){
        	$query->andWhere("product_category_id='".$catId."'" );
        }
    ...
    public function actionInquiry()
    {
    	...
    	if ($model->load($request->post()) && $model->validate()) { 
    		...
    		$model->companyName= $_POST['InquiryForm']['companyName'];
    		$model->address=$_POST['InquiryForm']['address'];
    		$model->phoneNo= $_POST['InquiryForm']['phoneNo'];
    		$model->name= $_POST['InquiryForm']['name'];
    		$model->inquiry= $_POST['InquiryForm']['inquiry'];
